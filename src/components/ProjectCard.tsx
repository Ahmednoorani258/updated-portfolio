...
export default function ProjectCard({ project }: { project: projectCard }) {
  return (
    <div className="flex flex-col justify-between bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300 border-t-4 border-green-500 dark:border-green-300">
      {/* Image Section */}
      {project.image ? (
        <Image
          src={project.image}
